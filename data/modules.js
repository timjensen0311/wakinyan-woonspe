    ...
    lessons: [
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            prompt: 'Háu', association: 'Sounds like "how" — as in "how are you, friend?"',
          ...
          {
            type: 'listen-identify',
            prompt: 'Háŋ', association: 'Sounds like a warm "hahn" — a gentle nod of greeting',
          ...
          {
            type: 'listen-identify',
            prompt: 'Aŋpétu wašté', association: '"Wash-TAY" — think of washing away the night to reveal a beautiful day',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tokša', association: '"Tohk-SHAH" — tuck your goodbye into your pocket, you\'ll be back',
            phonetic: 'tohk-SHAH',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tokša akhé', association: 'Tokša (goodbye) + akhé (again) — see you again',
          ...
          { type: 'listen-identify', prompt: 'Taŋyáŋ yahí', association: '"Yah-HEE" — like cheering "yay, you\'re here!"', phonetic: 'tahn-YAHN yah-HEE', meaning: 'You arrived well / Welcome', options: ['Goodbye', 'Good day', 'You arrived well', 'How are you?'], correct: 2 },
          { type: 'listen-identify', prompt: 'Níš eníš?', association: '"Neesh" — like "and you?" in a gentle nudge back', phonetic: 'neesh ay-NEESH', meaning: 'And you? / What about you?', options: ['Who are you?', 'And you?', 'Where are you?', 'How are you?'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'emáčiyapi', association: '"Eh-MAH-chee-yah-pee" — "I am a-CHEE-ved my name" — how they call me',
          ...
          {
            type: 'listen-identify',
            prompt: 'emátaŋhaŋ', association: '"Eh-MAH-tahn-hahn" — "my hometown" sounds similar',
          ...
          {
            type: 'listen-identify',
            prompt: 'Kȟolá', association: '"Koh-LAH" — think cola, sharing a drink with a buddy',
          ...
          {
            type: 'listen-identify',
            prompt: 'Mašké', association: '"Mah-SHKAY" — my girl pal, ma-SHKAY',
            phonetic: 'mah-SHKAY',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Philámayaye', association: '"Pee-LAH-mah-yah-yay" — a lot of syllables for a lot of gratitude',
          ...
          {
            type: 'listen-identify',
            prompt: 'Philámayayapi', association: 'Same as philámayaye but with "-pi" for plural — thanking the whole group',
          ...
          {
            type: 'listen-identify',
            prompt: 'Hiyá', association: '"Hee-YAH" — a strong "no!" like a karate chop',
            phonetic: 'hee-YAH',
            meaning: 'No',
          ...
          {
            type: 'listen-identify',
            prompt: 'Wašté', association: '"Wash-TAY" — a fresh wash makes everything look good/beautiful',
            phonetic: 'wash-TAY',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Waŋží', association: '"Wahn-ZHEE" — one-ZEE, number one',
            phonetic: 'wahn-ZHEE',
            meaning: '1 — One',
          ...
          {
            type: 'listen-identify',
            prompt: 'Núŋpa', association: '"NOON-pah" — two things at noon, a pair',
            phonetic: 'NOON-pah',
            meaning: '2 — Two',
          ...
          {
            type: 'listen-identify',
            prompt: 'Yámni', association: '"YAHM-nee" — yam + knee = three things on my mind',
            phonetic: 'YAHM-nee',
            meaning: '3 — Three',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tópa', association: '"TOH-pah" — four directions, the sacred number — think "topaz" has four facets',
            phonetic: 'TOH-pah',
          ...
          {
            type: 'listen-identify',
            prompt: 'Záptaŋ', association: '"ZAHP-tahn" — zap your five fingers, zap-tahn',
            phonetic: 'ZAHP-tahn',
            meaning: '5 — Five',
          ...
          {
            type: 'listen-identify',
            prompt: 'Wikčémna', association: '"Week-CHAYM-nah" — a "week" has almost 10 days in some cultures',
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Iná', association: '"Ee-NAH" — sounds like "in ah" — a baby\'s first sound for mama',
            phonetic: 'ee-NAH',
            meaning: 'Mother',
          ...
          {
            type: 'listen-identify',
            prompt: 'Até', association: '"Ah-TAY" — like "aw, dad" — short and strong like a father',
            phonetic: 'ah-TAY',
            meaning: 'Father',
          ...
          {
            type: 'listen-identify',
            prompt: 'Čhiŋkší', association: '"Cheenk-SHEE" — think of a tiny "chink" of light, a little boy',
          ...
          {
            type: 'listen-identify',
            prompt: 'Čhuŋkší', association: '"Choonk-SHEE" — daughter, similar to son (čhiŋkší) but with a rounder sound',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Thíblo', association: '"TEEB-loh" — big bro, like a deep "tee-blow" of strength',
            phonetic: 'TEEB-loh',
          ...
          {
            type: 'listen-identify',
            prompt: 'Misúŋ', association: '"Mee-SOONG" — my little "soong," my younger brother',
            phonetic: 'mee-SOONG',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tȟaŋkší', association: '"Tahnk-SHEE" — "thanks, sis" — thank-SHE, younger sister',
            phonetic: 'tahnk-SHEE',
          ...
          {
            type: 'listen-identify',
            prompt: 'Čhuwé', association: '"Choo-WAY" — big sis shows the way, "choose the WAY"',
            phonetic: 'choo-WAY',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Tȟuŋkášila', association: '"Toon-KAH-shee-lah" — a long, respectful word for a respected elder',
          ...
          {
            type: 'listen-identify',
            prompt: 'Uŋčí', association: '"Oon-CHEE" — warm like grandma\'s "oooh, sweetie"',
            phonetic: 'oon-CHEE',
          ...
          {
            type: 'listen-identify',
            prompt: 'Lekší', association: '"Lek-SHEE" — uncle looks out for you, like a "lookout-SHE-eld"',
            phonetic: 'lek-SHEE',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tȟuŋwíŋ', association: '"Toon-WEEN" — auntie who always wins your heart, "tune-WIN"',
            phonetic: 'toon-WEEN',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Thiyóšpaye', association: '"Tee-YOH-shpah-yay" — "the whole shpay" — the whole extended family spread',
          ...
          {
            type: 'listen-identify',
            prompt: 'Thiwáhe', association: '"Tee-WAH-hay" — your immediate "te-WAH-hey!" — the ones closest to home',
          ...
          {
            type: 'listen-identify',
            prompt: 'Thakóža', association: '"Tah-KOH-zhah" — grandchild, the "cocoa" of your life — sweet and warm',
          ...
          {
            type: 'listen-identify',
            prompt: 'Oyáte', association: '"Oh-YAH-tay" — the people, like "oh yeah, the whole nation"',
            phonetic: 'oh-YAH-tay',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Mitȟáwa', association: '"Mee-TAH-wah" — "me-TAH" — that\'s mine!',
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Haŋhépi', association: '"Hahn-HAY-pee" — night makes you feel "happy" to rest',
          ...
          {
            type: 'listen-identify',
            prompt: 'Híŋhaŋni', association: '"HEEN-hahn-nee" — the morning "hen" crows at dawn',
          ...
          {
            type: 'listen-identify',
            prompt: 'Wíyotaŋhaŋ', association: '"Wee-YOH-tahn-hahn" — the sun yo-yo\'s to its highest at noon',
          ...
          {
            type: 'listen-identify',
            prompt: 'Ȟtayétu', association: '"Htah-YAY-too" — the day is "fading away too" — evening',
          ...
          {
            type: 'listen-identify',
            prompt: 'Aŋpáo', association: '"Ahn-POW" — dawn hits you with a "pow!" of morning light',
            phonetic: 'ahn-POW',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Wóta', association: '"WOH-tah" — want-a bite? Time to eat',
            phonetic: 'WOH-tah',
          ...
          {
            type: 'listen-identify',
            prompt: 'Yatkáŋ', association: '"Yaht-KAHN" — "got a can" of something to drink',
            phonetic: 'yaht-KAHN',
          ...
          {
            type: 'listen-identify',
            prompt: 'Ištíŋma', association: '"Eesh-TEEN-mah" — eyes "shut-in-ma" — asleep',
          ...
          {
            type: 'listen-identify',
            prompt: 'Yá', association: '"YAH" — "yeah, let\'s go!"',
            phonetic: 'YAH',
            meaning: 'To go',
          ...
          {
            type: 'listen-identify',
            prompt: 'Hí', association: '"HEE" — "he\'s here!" — to arrive',
            phonetic: 'HEE',
          ...
          {
            type: 'listen-identify',
            prompt: 'Iyótaka', association: '"Ee-YOH-tah-kah" — "yo, take a" seat',
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Tókheškhe yaúŋ he?', association: 'Think: "TOH-kesh-keh" — "how\'s it going?" checking in on someone',
          ...
          {
            type: 'listen-identify',
            prompt: 'Taŋyáŋ waúŋ', association: '"Tahn-YAHN" — "I\'m doing fine, thanks"',
          ...
          {
            type: 'listen-identify',
            prompt: 'Wačhíŋ waštéya waúŋ', association: 'Wačhíŋ (mind) + waštéya (well) — my mind is in a good place',
          ...
          {
            type: 'listen-identify',
            prompt: 'Waṫȟáka waúŋ', association: '"Wah-TAH-kah" — too "tuckered" out — tired',
          ...
          {
            type: 'listen-identify',
            prompt: 'Lóčhiŋ waúŋ', association: '"LOH-cheen" — lunch-in — I need lunch, I\'m hungry',
          ...
          { type: 'listen-identify', prompt: 'Čhaŋté mašká', association: 'Čhaŋté (heart) + mašká (happy) — "my heart is dancing"', phonetic: 'chahn-TAY mah-SHKAH', meaning: 'My heart is happy', options: ['My heart is sad', 'My heart is strong', 'My heart is happy', 'I have a good heart'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wašté šni', association: 'Wašté (good) + šni (not) — "not good" = bad', phonetic: 'wash-TAY shnee', meaning: 'Not good / Bad', options: ['Very good', 'Not good', 'Okay', 'Beautiful'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Mní', association: '"Mnee" — sounds minimal, like a small sip of water',
            phonetic: 'mnee',
            meaning: 'Water',
          ...
          {
            type: 'listen-identify',
            prompt: 'Agúyapi', association: '"Ah-GOO-yah-pee" — "a gooey" fresh loaf of bread',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tȟaló', association: '"Tah-LOH" — "ta-LOW" on the cow — the meat',
            phonetic: 'tah-LOH',
            meaning: 'Meat',
          ...
          {
            type: 'listen-identify',
            prompt: 'Wóžapi', association: '"WOH-zhah-pee" — the berries go "whoosh" into the pudding',
          ...
          {
            type: 'listen-identify',
            prompt: 'Pȟežúta sápa', association: 'Pȟežúta (medicine) + sápa (black) — literally "black medicine" = coffee',
          ...
          {
            type: 'listen-identify',
            prompt: 'Wahánpi', association: '"Wah-HAHN-pee" — a warm "wah" of soup happiness',
          ...
          { type: 'listen-identify', prompt: 'Ípuza', association: '"EE-poo-zah" — "a pizza" makes you thirsty', phonetic: 'EE-poo-zah', meaning: 'Thirsty', options: ['Hungry', 'Thirsty', 'Full', 'Tired'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          {
            type: 'listen-identify',
            prompt: 'Tukté', association: '"Took-TAY" — "took-where?" — which way did they go?',
            phonetic: 'took-TAY',
            meaning: 'Where?',
          ...
          {
            type: 'listen-identify',
            prompt: 'Lé', association: '"LAY" — "lay" it right here — this/here',
            phonetic: 'LAY',
            meaning: 'This / Here',
          ...
          {
            type: 'listen-identify',
            prompt: 'Hé', association: '"HAY" — "hey, over there!" — that/there',
            phonetic: 'HAY',
            meaning: 'That / There',
          ...
          {
            type: 'listen-identify',
            prompt: 'Thimáhel', association: '"Tee-MAH-hel" — "the mahogany hall" — inside',
          ...
          {
            type: 'listen-identify',
            prompt: 'Tȟaŋkál', association: '"TAHN-kahl" — "tank" is outside, parked in the open',
            phonetic: 'TAHN-kahl',
            meaning: 'Outside',
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wiyóhiŋyaŋpata', association: '"Wee-YOH-heen" — where the sun rises, "we yo, the sun is here!"', phonetic: 'wee-YOH-heen-yahn-pah-tah', meaning: 'East (where the sun rises)', options: ['West', 'East', 'North', 'South'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wazíyata', association: '"Wah-ZEE-yah-tah" — the cold "breeze" comes from the north', phonetic: 'wah-ZEE-yah-tah', meaning: 'North', options: ['South', 'East', 'North', 'West'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wiyóhpeyata', association: '"Wee-YOH-pay" — the sun goes to "pay" its rest in the west', phonetic: 'wee-YOH-pay-yah-tah', meaning: 'West (where the sun sets)', options: ['East', 'North', 'West', 'South'], correct: 2 },
          { type: 'listen-identify', prompt: 'Itókağata', association: '"Ee-TOH-kah-gah-tah" — "it\'s toga" weather in the warm south', phonetic: 'ee-TOH-kah-gah-tah', meaning: 'South', options: ['North', 'South', 'East', 'West'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Tȟatȟáŋka', association: '"Tah-TAHN-kah" — think Tatanka from Dances with Wolves — buffalo', phonetic: 'tah-TAHN-kah', meaning: 'Buffalo', options: ['Horse', 'Buffalo', 'Eagle', 'Bear'], correct: 1 },
          { type: 'listen-identify', prompt: 'Waŋblí', association: '"Wahn-BLEE" — the eagle flies "wan-BLEE" — wonderfully free', phonetic: 'wahn-BLEE', meaning: 'Eagle', options: ['Hawk', 'Eagle', 'Owl', 'Crow'], correct: 1 },
          { type: 'listen-identify', prompt: 'Šuŋgmánitu Tȟáŋka', association: 'Šúŋka (dog) + mánitu (wild) + tȟáŋka (big) — "big wild dog" = wolf', phonetic: 'shoong-MAH-nee-too TAHN-kah', meaning: 'Wolf ("big dog of the wilderness")', options: ['Coyote', 'Bear', 'Wolf', 'Fox'], correct: 2 },
          { type: 'listen-identify', prompt: 'Mathó', association: '"Mah-TOH" — a bear has big "maw" and big "toe"', phonetic: 'mah-TOH', meaning: 'Bear', options: ['Buffalo', 'Wolf', 'Eagle', 'Bear'], correct: 3 },
          { type: 'listen-identify', prompt: 'Šúŋka', association: '"SHOON-kah" — think "shunk" — a loyal companion, man\'s best friend', phonetic: 'SHOON-kah', meaning: 'Dog', options: ['Horse', 'Dog', 'Wolf', 'Coyote'], correct: 1 },
          { type: 'listen-identify', prompt: 'Šuŋgáwakȟaŋ', association: 'Šúŋka (dog) + wakȟáŋ (sacred) — a "sacred dog" is how Lakota first described horses', phonetic: 'shoong-AH-wah-kahn', meaning: 'Horse ("sacred/powerful dog")', options: ['Dog', 'Buffalo', 'Horse', 'Elk'], correct: 2 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wakíŋyaŋ', association: '"Wah-KEEN-yahn" — the thunder being is "keen" and powerful', phonetic: 'wah-KEEN-yahn', meaning: 'Thunder Being / Thunder', options: ['Lightning', 'Thunder Being', 'Rain', 'Wind'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wakȟáŋȟežá', association: '"Wah-KAHN-hay-zhah" — lightning is the sacred flash', phonetic: 'wah-KAHN-hay-zhah', meaning: 'Lightning', options: ['Thunder', 'Lightning', 'Cloud', 'Storm'], correct: 1 },
          { type: 'listen-identify', prompt: 'Maȟpíya', association: '"Mah-HPEE-yah" — look up and say "my, oh my" at the sky', phonetic: 'mah-HPEE-yah', meaning: 'Sky / Cloud', options: ['Sky / Cloud', 'Star', 'Moon', 'Sun'], correct: 0 },
          { type: 'listen-identify', prompt: 'Wičháȟpi', association: '"Wee-CHAH-hpee" — "we see" the stars at night', phonetic: 'wee-CHAH-hpee', meaning: 'Star', options: ['Moon', 'Sun', 'Star', 'Cloud'], correct: 2 },
          { type: 'listen-identify', prompt: 'Haŋwí', association: '"Hahn-WEE" — the moon hangs "wee" in the night sky', phonetic: 'hahn-WEE', meaning: 'Moon', options: ['Star', 'Sun', 'Moon', 'Night'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wí', association: '"WEE" — the sun, small word for the biggest light', phonetic: 'WEE', meaning: 'Sun', options: ['Moon', 'Sun', 'Star', 'Day'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wétu', association: '"WAY-too" — "way too" many flowers blooming — spring!', phonetic: 'WAY-too', meaning: 'Spring', options: ['Spring', 'Summer', 'Fall', 'Winter'], correct: 0 },
          { type: 'listen-identify', prompt: 'Blokétu', association: '"Bloh-KAY-too" — "block the sun" — it\'s hot, it\'s summer', phonetic: 'bloh-KAY-too', meaning: 'Summer', options: ['Spring', 'Summer', 'Fall', 'Winter'], correct: 1 },
          { type: 'listen-identify', prompt: 'Ptaŋyétu', association: '"Ptahn-YAY-too" — plants "put away" their leaves — fall', phonetic: 'ptahn-YAY-too', meaning: 'Fall / Autumn', options: ['Spring', 'Summer', 'Fall', 'Winter'], correct: 2 },
          { type: 'listen-identify', prompt: 'Waníyetu', association: '"Wah-NEE-yay-too" — "wannabe warm" — winter is cold', phonetic: 'wah-NEE-yay-too', meaning: 'Winter', options: ['Spring', 'Summer', 'Fall', 'Winter'], correct: 3 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Makȟá', association: '"Mah-KAH" — "mama earth" — the land beneath us', phonetic: 'mah-KAH', meaning: 'Earth / Land', options: ['Sky', 'Earth / Land', 'Water', 'Fire'], correct: 1 },
          { type: 'listen-identify', prompt: 'Pȟéta', association: '"PAY-tah" — fire is like a "pay day" of warmth', phonetic: 'PAY-tah', meaning: 'Fire', options: ['Water', 'Earth', 'Fire', 'Wind'], correct: 2 },
          { type: 'listen-identify', prompt: 'Tȟáte', association: '"TAH-tay" — the wind gives you a gentle "tah-tay" tap', phonetic: 'TAH-tay', meaning: 'Wind', options: ['Fire', 'Water', 'Earth', 'Wind'], correct: 3 },
          { type: 'listen-identify', prompt: 'Ȟé', association: '"HAY" — like hay on a hillside', phonetic: 'HAY (breathy)', meaning: 'Hill / Mountain', options: ['River', 'Hill / Mountain', 'Tree', 'Rock'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čhaŋ', association: '"CHAHN" — a tree stands in a "channel" of light', phonetic: 'CHAHN', meaning: 'Tree / Wood', options: ['Stone', 'Water', 'Tree / Wood', 'Grass'], correct: 2 },
          { type: 'listen-identify', prompt: 'Iŋyáŋ', association: '"Een-YAHN" — a stone goes "in yonder" pile', phonetic: 'een-YAHN', meaning: 'Stone / Rock', options: ['Tree', 'Hill', 'Stone / Rock', 'Earth'], correct: 2 },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wašná', association: '"Wash-NAH" — wash your hands before eating this pemmican treat', phonetic: 'wash-NAH', meaning: 'Pemmican (dried meat with berries and fat)', options: ['Soup', 'Pemmican', 'Bread', 'Berry pudding'], correct: 1 },
          { type: 'listen-identify', prompt: 'Thíŋpsiŋla', association: '"TEENP-seen-lah" — a "teeny" little turnip from the prairie', phonetic: 'TEENP-seen-lah', meaning: 'Turnip (prairie turnip — a traditional root food)', options: ['Corn', 'Turnip', 'Potato', 'Berry'], correct: 1 },
          { type: 'listen-identify', prompt: 'Tȟaŋíǧa', association: '"Tahn-EE-gah" — a traditional delicacy, tripe — an acquired taste!', phonetic: 'tahn-EE-gah', meaning: 'Tripe / Intestine (traditional delicacy)', options: ['Tripe', 'Steak', 'Ribs', 'Liver'], correct: 0 },
          { type: 'listen-identify', prompt: 'Papa', association: '"Pah-PAH" — papa made the dried meat/jerky', phonetic: 'pah-PAH', meaning: 'Dried meat / Jerky', options: ['Bread', 'Fresh meat', 'Dried meat / Jerky', 'Fish'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wóyute', association: '"WOH-yoo-tay" — "woe to you" if there\'s no food!', phonetic: 'WOH-yoo-tay', meaning: 'Food (general)', options: ['Drink', 'Food', 'Meal', 'Plate'], correct: 1 },
          { type: 'listen-identify', prompt: 'Waskúyečha', association: '"Wah-SKOO-yay-chah" — "was cool, yeah?" — refreshing fruit', phonetic: 'wah-SKOO-yay-chah', meaning: 'Fruit', options: ['Vegetable', 'Meat', 'Fruit', 'Grain'], correct: 2 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Ȟáŋ', association: '"HAHN" — the pot goes "haaaahn" as it boils', phonetic: 'HAHN (breathy h)', meaning: 'To boil / To cook by boiling', options: ['To fry', 'To boil', 'To cut', 'To stir'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čhéǧa', association: '"CHAY-gah" — "check the" kettle on the fire', phonetic: 'CHAY-gah', meaning: 'Kettle / Pot', options: ['Plate', 'Kettle / Pot', 'Knife', 'Bowl'], correct: 1 },
          { type: 'listen-identify', prompt: 'Míla', association: '"MEE-lah" — "me-la" has a sharp knife', phonetic: 'MEE-lah', meaning: 'Knife', options: ['Spoon', 'Pot', 'Knife', 'Fire'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wíčhokaya', association: '"Wee-CHOH-kah-yah" — "we stir, okay? yeah!"', phonetic: 'wee-CHOH-kah-yah', meaning: 'To stir', options: ['To cut', 'To stir', 'To boil', 'To serve'], correct: 1 },
          { type: 'listen-identify', prompt: 'Ohéhaŋ', association: '"Oh-HAY-hahn" — "oh hey, cooking!" — to prepare food', phonetic: 'oh-HAY-hahn', meaning: 'To cook / To prepare food', options: ['To eat', 'To serve', 'To cook', 'To clean'], correct: 2 },
          ...
          { type: 'listen-identify', prompt: 'Káǧa', association: '"KAH-gah" — "gotta" make something', phonetic: 'KAH-gah', meaning: 'To make / To create', options: ['To cook', 'To make', 'To cut', 'To serve'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wóta wo', association: 'Wóta (eat) + wo (do it!) — friendly command to eat up', phonetic: 'WOH-tah woh', meaning: 'Eat! (a friendly command)', options: ['Drink!', 'Eat!', 'Sit down!', 'Come here!'], correct: 1 },
          { type: 'listen-identify', prompt: 'Yatkáŋ wo', association: 'Yatkáŋ (drink) + wo (do it!) — friendly command to drink up', phonetic: 'yaht-KAHN woh', meaning: 'Drink! (a friendly command)', options: ['Eat!', 'Sleep!', 'Drink!', 'Go!'], correct: 2 },
          { type: 'listen-identify', prompt: 'Lóčhiŋ he?', association: 'Lóčhiŋ (hungry) + he (question) — "are you hungry?"', phonetic: 'LOH-cheen hay', meaning: 'Are you hungry?', options: ['Are you thirsty?', 'Are you tired?', 'Are you hungry?', 'Are you cold?'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wóta po', association: 'Wóta (eat) + po (plural command) — "everyone eat!"', phonetic: 'WOH-tah poh', meaning: 'Eat! (to a group — plural)', options: ['Eat (one person)!', 'Eat (group)!', 'Cook!', 'Serve!'], correct: 1 },
          ...
          { type: 'listen-identify', prompt: 'Íyehaŋtu', association: '"EE-yay-hahn-too" — "it\'s enough" — ready/done', phonetic: 'EE-yay-hahn-too', meaning: 'It\'s time / The time has come', options: ['It\'s early', 'It\'s late', 'It\'s time', 'It\'s over'], correct: 2 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wóyute wašté', association: 'Wóyute (food) + wašté (good) — "the food is good!"', phonetic: 'WOH-yoo-tay wash-TAY', meaning: 'The food is good / Delicious food', options: ['Bad food', 'Good food', 'Hot food', 'More food'], correct: 1 },
          { type: 'listen-identify', prompt: 'Sáŋm', association: '"SAHNM" — "some more" — just a bit more please',  phonetic: 'SAHNM', meaning: 'More', options: ['Less', 'Enough', 'More', 'None'], correct: 2 },
          { type: 'listen-identify', prompt: 'Imáǧaga', association: '"Ee-MAH-gah-gah" — "I\'m a-gah-gah" — stuffed, can\'t eat more', phonetic: 'ee-MAH-gah-gah', meaning: 'I am full', options: ['I am hungry', 'I am full', 'I am thirsty', 'I want more'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wópȟila', association: '"WOH-pee-lah" — grateful, like "wonderful" gratitude', phonetic: 'WOH-pee-lah', meaning: 'Grateful / Thankful (a state of being)', options: ['Hungry', 'Grateful', 'Tired', 'Happy'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wóčhekiye', association: '"WOH-chay-kee-yay" — "whoa, I\'m praying" — prayer', phonetic: 'WOH-chay-kee-yay', meaning: 'Prayer', options: ['Song', 'Prayer', 'Food', 'Dance'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wóphila', association: '"WOH-pee-lah" — a thanksgiving offering of gratitude', phonetic: 'WOH-pee-lah', meaning: 'Thanksgiving / Gratitude offering', options: ['Prayer', 'Thanksgiving', 'Meal', 'Song'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wóthaŋiŋ', association: '"WOH-tah-neen" — a "whole lot of eatin\'" — a feast', phonetic: 'WOH-tah-neen', meaning: 'Feast / A big community meal', options: ['Snack', 'Fast', 'Feast', 'Leftovers'], correct: 2 },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wakȟáŋ Tȟáŋka', association: 'Wakȟáŋ (sacred) + Tȟáŋka (great) — the Great Sacred Mystery', phonetic: 'wah-KAHN TAHN-kah', meaning: 'The Great Mystery / The Great Spirit', options: ['The Thunder Being', 'The Great Mystery', 'The Sacred Pipe', 'The Sundance'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wakȟáŋ', association: '"Wah-KAHN" — think "walk on" holy ground — sacred', phonetic: 'wah-KAHN', meaning: 'Sacred / Holy / Mysterious', options: ['Big', 'Sacred / Holy', 'Old', 'Powerful'], correct: 1 },
          { type: 'listen-identify', prompt: 'Tȟáŋka', association: '"TAHN-kah" — like a "tank" — big and powerful', phonetic: 'TAHN-kah', meaning: 'Great / Big / Large', options: ['Small', 'Sacred', 'Great / Big', 'Fast'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wičhóni', association: '"Wee-CHOH-nee" — "we chose" to live — life', phonetic: 'wee-CHOH-nee', meaning: 'Life', options: ['Death', 'Life', 'Spirit', 'Prayer'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Óŋšimala ye', association: '"OHN-shee-mah-lah" — a humble request for compassion', phonetic: 'OHN-shee-mah-lah yay', meaning: 'Have pity on me / Have compassion for me', options: ['Thank you', 'Have pity on me', 'Forgive me', 'Help me'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čhekíya', association: '"Chay-KEE-yah" — "check in with" the Creator — to pray', phonetic: 'chay-KEE-yah', meaning: 'To pray / I pray', options: ['To sing', 'To dance', 'To pray', 'To cry'], correct: 2 },
          { type: 'listen-identify', prompt: 'Ómakȟiya ye', association: '"OH-mah-kee-yah" — "oh, make it" better — help me', phonetic: 'OH-mah-kee-yah yay', meaning: 'Help me', options: ['Forgive me', 'Help me', 'Hear me', 'Watch me'], correct: 1 },
          { type: 'listen-identify', prompt: 'Nážiŋ', association: '"NAH-zheen" — stand up like a "gnarly" warrior', phonetic: 'NAH-zheen', meaning: 'To stand / Stand up', options: ['To sit', 'To stand', 'To kneel', 'To walk'], correct: 1 },
          { type: 'listen-identify', prompt: 'Hoháŋ', association: '"Hoh-HAHN" — like "amen" — so be it',  phonetic: 'hoh-HAHN', meaning: 'Let it be so / Amen', options: ['Hello', 'Let it be so / Amen', 'Thank you', 'Goodbye'], correct: 1 },
          ...
          { type: 'listen-identify', prompt: 'Wóčhekiye', association: '"WOH-chay-kee-yay" — "whoa, I\'m praying" — prayer', phonetic: 'WOH-chay-kee-yay', meaning: 'Prayer / Prayers', options: ['Song', 'Dance', 'Prayer', 'Teaching'], correct: 2 },
          { type: 'listen-identify', prompt: 'Oúŋspe', association: '"Oh-OON-spay" — a teaching, like this app\'s name: Wóuŋspe', phonetic: 'oh-OON-spay', meaning: 'Teaching / Lesson', options: ['Prayer', 'Song', 'Story', 'Teaching'], correct: 3 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Čhaŋnúŋpa', association: '"Chahn-NOON-pah" — čhaŋ (wood) + núŋpa (two) — the pipe has two parts: bowl and stem', phonetic: 'chahn-NOON-pah', meaning: 'Sacred Pipe', options: ['Drum', 'Sacred Pipe', 'Eagle feather', 'Prayer flag'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čhaŋ Wákȟaŋ', association: 'Čhaŋ (tree) + Wákȟaŋ (sacred) — the sacred Sundance tree', phonetic: 'CHAHN WAH-kahn', meaning: 'Sacred Tree (the Sundance tree)', options: ['Prayer flag', 'Sacred fire', 'Sacred Tree', 'Sacred Pipe'], correct: 2 },
          { type: 'listen-identify', prompt: 'Čhaŋčhéǧa', association: '"Chahn-CHAY-gah" — the drum goes "chahhn-chay" with each beat', phonetic: 'chahn-CHAY-gah', meaning: 'Drum', options: ['Pipe', 'Drum', 'Whistle', 'Rattle'], correct: 1 },
          { type: 'listen-identify', prompt: 'Waphéyata', association: '"Wah-PAY-yah-tah" — prayer ties "wave" in the wind', phonetic: 'wah-PAY-yah-tah', meaning: 'Banner / Prayer flag / Prayer tie', options: ['Eagle feather', 'Sacred Pipe', 'Prayer flag / tie', 'Song'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wanáǧi', association: '"Wah-NAH-ghee" — spirit, like a "wanna-be" ghost floating by', phonetic: 'wah-NAH-ghee', meaning: 'Spirit / Ghost / Soul', options: ['Body', 'Spirit / Soul', 'Prayer', 'Dream'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wiwáŋyaŋg Wačhípi', association: '"Wee-WAHN-yahng wah-CHEE-pee" — gazing at the sun while dancing', phonetic: 'wee-WAHN-yahng wah-CHEE-pee', meaning: 'Sundance ("Gazing at the Sun Dance")', options: ['Sweat lodge', 'Sundance', 'Vision quest', 'Pipe ceremony'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wačhípi', association: '"Wah-CHEE-pee" — "watching" people dance', phonetic: 'wah-CHEE-pee', meaning: 'Dance / A dance', options: ['Song', 'Prayer', 'Dance', 'Feast'], correct: 2 },
          { type: 'listen-identify', prompt: 'Olówaŋ', association: '"Oh-LOH-wahn" — a song that goes "oh, la la"', phonetic: 'oh-LOH-wahn', meaning: 'Song', options: ['Dance', 'Song', 'Prayer', 'Drum'], correct: 1 },
          { type: 'listen-identify', prompt: 'Inipi', association: '"Ee-NEE-pee" — "in a teepee" you sweat and pray — to live again', phonetic: 'ee-NEE-pee', meaning: 'Sweat lodge ceremony ("to live again")', options: ['Sundance', 'Vision quest', 'Sweat lodge', 'Pipe ceremony'], correct: 2 },
          { type: 'listen-identify', prompt: 'Haŋbléčheya', association: '"Hahn-BLAY-chay-yah" — "crying for a dream" on the hillside', phonetic: 'hahn-BLAY-chay-yah', meaning: 'Vision quest ("crying for a dream")', options: ['Sweat lodge', 'Sundance', 'Feast', 'Vision quest'], correct: 3 },
          { type: 'listen-identify', prompt: 'Wičháša Wakȟáŋ', association: 'Wičháša (man) + Wakȟáŋ (holy) — a holy man / medicine man', phonetic: 'wee-CHAH-shah wah-KAHN', meaning: 'Holy man / Medicine man', options: ['Chief', 'Holy man', 'Warrior', 'Elder'], correct: 1 },
          ...
          { type: 'listen-identify', prompt: 'Khuží', association: '"Khoo-ZHEE" — feeling "woozy" — struggling', phonetic: 'khoo-ZHEE', meaning: 'Struggling / Weakened / Having a hard time', options: ['Strong', 'Struggling', 'Dancing', 'Resting'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Mitákuye Oyásʼiŋ', association: '"Mee-TAH-koo-yay oh-YAH-seen" — the most important phrase: We Are All Related', phonetic: 'mee-TAH-koo-yay oh-YAH-seen', meaning: 'All my relatives / We are all related', options: ['The Great Spirit watches', 'We are all related', 'Let it be so', 'Walk in beauty'], correct: 1 },
          { type: 'listen-identify', prompt: 'Takúye', association: '"Tah-KOO-yay" — "to cool with" your relatives', phonetic: 'tah-KOO-yay', meaning: 'Relative / Relation', options: ['Friend', 'Stranger', 'Relative', 'Elder'], correct: 2 },
          { type: 'listen-identify', prompt: 'Oyásʼiŋ', association: '"Oh-YAH-seen" — "all" of us, everything, everyone', phonetic: 'oh-YAH-seen', meaning: 'All / Everything', options: ['Some', 'None', 'All / Everything', 'Many'], correct: 2 },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Tuwá', association: '"Too-WAH" — "to-WHAT person?" — who?', phonetic: 'too-WAH', meaning: 'Who?', options: ['What?', 'Who?', 'Where?', 'When?'], correct: 1 },
          { type: 'listen-identify', prompt: 'Táku', association: '"TAH-koo" — "talk-oo" about what? — what?', phonetic: 'TAH-koo', meaning: 'What?', options: ['Who?', 'When?', 'What?', 'Why?'], correct: 2 },
          { type: 'listen-identify', prompt: 'Tóhaŋ', association: '"TOH-hahn" — "to when?" — when?', phonetic: 'TOH-hahn', meaning: 'When?', options: ['Where?', 'What?', 'When?', 'How?'], correct: 2 },
          { type: 'listen-identify', prompt: 'Tókheča', association: '"TOH-kay-chah" — "to-KAY, why?" — why/how?', phonetic: 'TOH-kay-chah', meaning: 'Why? / How?', options: ['Who?', 'What?', 'Where?', 'Why? / How?'], correct: 3 },
          { type: 'listen-identify', prompt: 'Tóna', association: '"TOH-nah" — "to-NAH" how many? — counting question', phonetic: 'TOH-nah', meaning: 'How many?', options: ['How much?', 'How many?', 'How far?', 'How long?'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wóta waúŋ', association: 'Wóta (eat) + waúŋ (I am) — I am eating right now', phonetic: 'WOH-tah wah-OON', meaning: 'I am eating', options: ['I am sleeping', 'I am eating', 'I am going', 'I am cooking'], correct: 1 },
          { type: 'listen-identify', prompt: 'Yá waúŋ', association: 'Yá (go) + waúŋ (I am) — I am going', phonetic: 'YAH wah-OON', meaning: 'I am going', options: ['I am eating', 'I am coming', 'I am going', 'I am sitting'], correct: 2 },
          { type: 'listen-identify', prompt: 'Hí waúŋ', association: 'Hí (come) + waúŋ (I am) — I am coming / I have arrived', phonetic: 'HEE wah-OON', meaning: 'I am coming / I have arrived', options: ['I am going', 'I am leaving', 'I am coming', 'I am waiting'], correct: 2 },
          { type: 'listen-identify', prompt: 'Škaŋ', association: '"SHKAHN" — "shakin\'" and moving — to be active', phonetic: 'SHKAHN', meaning: 'To do / To move / To be active', options: ['To sit', 'To do / move', 'To eat', 'To sleep'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wópilaštaya', association: '"WOH-pee-lah-shtah-yah" — overflowing with gratitude', phonetic: 'WOH-pee-lah-shtah-yah', meaning: 'I am grateful / I am thankful', options: ['I am tired', 'I am angry', 'I am grateful', 'I am lost'], correct: 2 },
          { type: 'listen-identify', prompt: 'Čhaŋtéšiča', association: 'Čhaŋté (heart) + šiča (bad) — a heavy, sad heart', phonetic: 'chahn-TAY-shee-chah', meaning: 'Sad / Heavy-hearted', options: ['Happy', 'Sad', 'Angry', 'Tired'], correct: 1 },
          { type: 'listen-identify', prompt: 'Oháŋ', association: '"Oh-HAHN" — "oh, okay" — I agree', phonetic: 'oh-HAHN', meaning: 'Yes / Okay / I agree', options: ['No', 'Maybe', 'Yes / Okay', 'I don\'t know'], correct: 2 },
          { type: 'listen-identify', prompt: 'Sníya', association: '"SNEE-yah" — "snowy" and cold — brrr!', phonetic: 'SNEE-yah', meaning: 'Cold (I am cold)', options: ['Hot', 'Cold', 'Tired', 'Wet'], correct: 1 },
          { type: 'listen-identify', prompt: 'Lílá', association: '"LEE-lah" — "really?" — very/really, an intensifier', phonetic: 'LEE-lah', meaning: 'Very / Really', options: ['Not', 'A little', 'Very / Really', 'Sometimes'], correct: 2 },
          ...
          { type: 'listen-identify', prompt: 'Héčhetu yeló', association: '"HAY-chay-too" — "hey, that\'s true" — indeed (men)', phonetic: 'HAY-chay-too yay-LOH', meaning: 'That is so / Indeed (said by men)', options: ['I don\'t know', 'That is so', 'Maybe', 'Not really'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Háŋ, háŋ', association: 'Double "háŋ" — emphatic agreement: "yes, yes, I\'m listening"', phonetic: 'HAHN, HAHN', meaning: 'Yes, yes (I\'m listening / I agree)', options: ['No, no', 'Yes, yes (listening)', 'Maybe, maybe', 'I don\'t know'], correct: 1 },
          { type: 'listen-identify', prompt: 'Héčhetu', association: '"HAY-chay-too" — "hey, check it" — that\'s how it is', phonetic: 'HAY-chay-too', meaning: 'That\'s right / That\'s so / Indeed', options: ['That\'s wrong', 'That\'s right / Indeed', 'I don\'t know', 'Maybe'], correct: 1 },
          { type: 'listen-identify', prompt: 'Slolwáye šni', association: 'Slolwáye (I know) + šni (not) — I don\'t know', phonetic: 'slohl-WAH-yay shnee', meaning: 'I don\'t know / I don\'t understand', options: ['I know', 'I don\'t know', 'I agree', 'I\'m listening'], correct: 1 },
          { type: 'listen-identify', prompt: 'Tókheškhe?', association: '"TOH-kesh-keh" — "token question" — how? what do you mean?', phonetic: 'TOH-kesh-keh', meaning: 'How? / What do you mean?', options: ['Where?', 'Who?', 'How? / What do you mean?', 'When?'], correct: 2 },
          { type: 'listen-identify', prompt: 'Hó', association: '"HOH" — "ho!" — yes, okay, go ahead (masculine)', phonetic: 'HOH', meaning: 'Yes / Okay / Go ahead (male speaker)', options: ['No', 'Stop', 'Yes / Go ahead', 'Wait'], correct: 2 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Ówakhiye kte', association: '"OH-wah-kee-yay" — "okay, I\'ll help" — I will help', phonetic: 'OH-wah-kee-yay ktay', meaning: 'I will help', options: ['I need help', 'I will help', 'Can you help?', 'Help me'], correct: 1 },
          { type: 'listen-identify', prompt: 'Yahé kte he?', association: '"Yah-HAY" — "yeah, hey" — are you leaving?', phonetic: 'yah-HAY ktay hay', meaning: 'Are you leaving?', options: ['Are you coming?', 'Are you staying?', 'Are you leaving?', 'Are you ready?'], correct: 2 },
    ...
    lessons: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Óčhičhiya oyákihi he?', association: '"OH-chee-chee-yah" — can I help you?', phonetic: 'OH-chee-chee-yah oh-YAH-kee-hee hay', meaning: 'Can I help you?', options: ['Where are you going?', 'Can I help you?', 'What are you doing?', 'Do you need water?'], correct: 1 },
          { type: 'listen-identify', prompt: 'Táku ečhámuŋ kta he?', association: '"TAH-koo ay-CHAH-moon" — what should I do?', phonetic: 'TAH-koo ay-CHAH-moon ktah hay', meaning: 'What should I do?', options: ['What is that?', 'What should I do?', 'What are you eating?', 'What happened?'], correct: 1 },
          { type: 'listen-identify', prompt: 'Mní awakú kte', association: 'Mní (water) + awakú (bring) — I will bring water', phonetic: 'MNEE ah-wah-KOO ktay', meaning: 'I will bring water', options: ['I need water', 'I will bring water', 'Where is the water?', 'I am thirsty'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čhaŋ awakú kte', association: 'Čhaŋ (wood) + awakú (bring) — I will bring firewood', phonetic: 'CHAHN ah-wah-KOO ktay', meaning: 'I will bring firewood', options: ['I need wood', 'I will bring firewood', 'I will start a fire', 'Where is the wood?'], correct: 1 },
          ...
          { type: 'listen-identify', prompt: 'Thípi', association: '"TEE-pee" — the classic tipi — a dwelling', phonetic: 'TEE-pee', meaning: 'Tipi / Dwelling / Lodge', options: ['Tent', 'Tipi', 'Kitchen', 'Arbor'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Hóka hé!', association: '"HOH-kah HAY" — a rallying shout, like "let\'s go!"', phonetic: 'HOH-kah HAY', meaning: 'An encouragement call (like "Let\'s go!" or "Be strong!")', options: ['Stop!', 'An encouragement call', 'Come here!', 'Be quiet!'], correct: 1 },
          { type: 'listen-identify', prompt: 'Íyohlate', association: '"EE-yoh-hlah-tay" — "yo, hang in there" — be strong', phonetic: 'EE-yoh-hlah-tay', meaning: 'Be strong / Endure / Hang in there', options: ['Be quiet', 'Be strong / Endure', 'Go fast', 'Be careful'], correct: 1 },
          { type: 'listen-identify', prompt: 'Thečhíȟila', association: '"Tay-CHEE-hee-lah" — "teach-ee" your heart — I love you', phonetic: 'tay-CHEE-hee-lah', meaning: 'I love you / I hold you dear', options: ['I miss you', 'I love you', 'I thank you', 'I see you'], correct: 1 },
          ...
          { type: 'listen-identify', prompt: 'Wačhíŋtȟaŋka yo', association: 'Wačhíŋ (mind) + tȟáŋka (great) — have a great/strong mind — be brave!', phonetic: 'wah-CHEEN-tahn-kah yoh', meaning: 'Be strong! / Have courage! (to a man)', options: ['Be quiet!', 'Be strong!', 'Be careful!', 'Be patient!'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Wóphila tȟáŋka', association: 'Wóphila (gratitude) + tȟáŋka (great) — deep, great thanks', phonetic: 'WOH-pee-lah TAHN-kah', meaning: 'Great gratitude / Deep thanks', options: ['Small thanks', 'Great gratitude', 'Goodbye forever', 'See you soon'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čhaŋté wašté', association: 'Čhaŋté (heart) + wašté (good) — a good heart, with good intentions', phonetic: 'chahn-TAY wash-TAY', meaning: 'Good heart / With a good heart', options: ['Sad heart', 'Good heart', 'Strong heart', 'Big heart'], correct: 1 },
    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Natá', association: '"Nah-TAH" — "not a" hat needed — it goes on your head', phonetic: 'nah-TAH', meaning: 'Head', options: ['Hand', 'Foot', 'Head', 'Heart'], correct: 2 },
          { type: 'listen-identify', prompt: 'Ištá', association: '"Eesh-TAH" — "I stare" with my eyes', phonetic: 'eesh-TAH', meaning: 'Eye', options: ['Ear', 'Eye', 'Nose', 'Mouth'], correct: 1 },
          { type: 'listen-identify', prompt: 'Núge', association: '"NOO-gay" — "new" sounds come through your ears', phonetic: 'NOO-gay', meaning: 'Ear', options: ['Eye', 'Nose', 'Ear', 'Mouth'], correct: 2 },
          { type: 'listen-identify', prompt: 'Pahú', association: '"Pah-HOO" — "pa-WHO" smells that? — nose', phonetic: 'pah-HOO', meaning: 'Nose', options: ['Nose', 'Ear', 'Eye', 'Head'], correct: 0 },
          { type: 'listen-identify', prompt: 'Í', association: '"EE" — a tiny word for your mouth, always open', phonetic: 'EE', meaning: 'Mouth', options: ['Eye', 'Mouth', 'Nose', 'Ear'], correct: 1 },
          { type: 'listen-identify', prompt: 'Napé', association: '"Nah-PAY" — "nab" things with your hands — to grab and hold', phonetic: 'nah-PAY', meaning: 'Hand', options: ['Foot', 'Hand', 'Arm', 'Finger'], correct: 1 },
          { type: 'listen-identify', prompt: 'Sí', association: '"SHEE" — your feet, always "she" goes walking', phonetic: 'SHEE', meaning: 'Foot', options: ['Hand', 'Leg', 'Foot', 'Toe'], correct: 2 },
          { type: 'listen-identify', prompt: 'Čhaŋkpé', association: '"Chahn-KPAY" — "can\'t play" if your knee hurts', phonetic: 'chahn-KPAY', meaning: 'Knee', options: ['Elbow', 'Knee', 'Ankle', 'Shoulder'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Lutá', association: '"Loo-TAH" — think red as "loot" — red treasure', phonetic: 'loo-TAH', meaning: 'Red', options: ['Black', 'Red', 'White', 'Yellow'], correct: 1 },
          { type: 'listen-identify', prompt: 'Ská', association: '"SKAH" — "sky" white, bright and clean', phonetic: 'SKAH', meaning: 'White', options: ['White', 'Black', 'Blue', 'Red'], correct: 0 },
          { type: 'listen-identify', prompt: 'Sapá', association: '"Shah-PAH" — "shadow" dark — black', phonetic: 'shah-PAH', meaning: 'Black', options: ['White', 'Red', 'Yellow', 'Black'], correct: 3 },
          { type: 'listen-identify', prompt: 'Zí', association: '"ZEE" — like a buzzing "bee" on a yellow flower', phonetic: 'ZEE', meaning: 'Yellow', options: ['Green', 'Yellow', 'Blue', 'Brown'], correct: 1 },
          { type: 'listen-identify', prompt: 'Tȟó', association: '"TOH" — "tone" of the blue/green sky and earth', phonetic: 'TOH (breathy)', meaning: 'Blue / Green', options: ['Red', 'Yellow', 'Blue / Green', 'Brown'], correct: 2 },
          { type: 'listen-identify', prompt: 'Ǧí', association: '"GHEE" — like clarified butter — golden brown', phonetic: 'GHEE (throaty)', meaning: 'Brown / Tan', options: ['Gray', 'Brown / Tan', 'Black', 'Yellow'], correct: 1 },
          { type: 'listen-identify', prompt: 'Hóta', association: '"HOH-tah" — a "hotter" shade fades to gray', phonetic: 'HOH-tah', meaning: 'Gray', options: ['Brown', 'White', 'Gray', 'Black'], correct: 2 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Héȟaka', association: '"HAY-hah-kah" — "hey, look!" — a majestic elk', phonetic: 'HAY-hah-kah', meaning: 'Elk', options: ['Deer', 'Elk', 'Moose', 'Buffalo'], correct: 1 },
          { type: 'listen-identify', prompt: 'Tȟáȟča', association: '"TAH-hchah" — deer are "ta-da!" — appearing and disappearing', phonetic: 'TAH-hchah', meaning: 'Deer', options: ['Elk', 'Horse', 'Deer', 'Antelope'], correct: 2 },
          { type: 'listen-identify', prompt: 'Maštíŋčala', association: '"Mah-SHTEEN-chah-lah" — a tiny, soft little rabbit', phonetic: 'mah-SHTEEN-chah-lah', meaning: 'Rabbit', options: ['Mouse', 'Squirrel', 'Rabbit', 'Prairie Dog'], correct: 2 },
          { type: 'listen-identify', prompt: 'Kȟeǧá', association: '"KAY-gah" — a turtle is never in a hurry, "okay, gah"', phonetic: 'KAY-gah (throaty)', meaning: 'Turtle', options: ['Frog', 'Turtle', 'Snake', 'Lizard'], correct: 1 },
          { type: 'listen-identify', prompt: 'Iktómi', association: '"Eek-TOH-mee" — "eek!" the trickster spider', phonetic: 'eek-TOH-mee', meaning: 'Spider (the Trickster)', options: ['Ant', 'Spider', 'Butterfly', 'Beetle'], correct: 1 },
          { type: 'listen-identify', prompt: 'Uŋčéǧila', association: '"Oon-CHAY-ghee-lah" — the snake "un-CHAINs" itself, slithering', phonetic: 'oon-CHAY-ghee-lah', meaning: 'Snake', options: ['Worm', 'Lizard', 'Turtle', 'Snake'], correct: 3 },
          { type: 'listen-identify', prompt: 'Hogáŋ', association: '"Hoh-GAHN" — fish are "hog" wild in the water', phonetic: 'hoh-GAHN', meaning: 'Fish', options: ['Fish', 'Frog', 'Otter', 'Turtle'], correct: 0 },
          { type: 'listen-identify', prompt: 'Kȟaŋǧí', association: '"KAHN-ghee" — the crow caws "kahn-ghee!"', phonetic: 'KAHN-ghee', meaning: 'Crow', options: ['Eagle', 'Hawk', 'Owl', 'Crow'], correct: 3 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Máni', association: '"MAH-nee" — "many" steps when you walk', phonetic: 'MAH-nee', meaning: 'Walk', options: ['Run', 'Walk', 'Stand', 'Sit'], correct: 1 },
          { type: 'listen-identify', prompt: 'Íŋyaŋka', association: '"EEN-yahn-kah" — "in ya go" running — fast!', phonetic: 'EEN-yahn-kah', meaning: 'Run', options: ['Walk', 'Jump', 'Run', 'Dance'], correct: 2 },
          { type: 'listen-identify', prompt: 'Lowáŋ', association: '"Loh-WAHN" — sing a song, "la la la"', phonetic: 'loh-WAHN', meaning: 'Sing', options: ['Pray', 'Sing', 'Dance', 'Cry'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wačhí', association: '"Wah-CHEE" — "watch me" dance!', phonetic: 'wah-CHEE', meaning: 'Dance', options: ['Sing', 'Pray', 'Dance', 'Walk'], correct: 2 },
          { type: 'listen-identify', prompt: 'Čhéya', association: '"CHAY-yah" — tears "chase ya" — to cry', phonetic: 'CHAY-yah', meaning: 'Cry', options: ['Laugh', 'Cry', 'Sing', 'Shout'], correct: 1 },
          { type: 'listen-identify', prompt: 'Iȟáȟa', association: '"Ee-HAH-hah" — it IS "ha ha" — to laugh!', phonetic: 'ee-HAH-hah', meaning: 'Laugh', options: ['Cry', 'Smile', 'Laugh', 'Talk'], correct: 2 },
          { type: 'listen-identify', prompt: 'Nážiŋ', association: '"NAH-zheen" — stand up like a "gnarly" warrior', phonetic: 'NAH-zheen', meaning: 'Stand', options: ['Sit', 'Stand', 'Walk', 'Lie down'], correct: 1 },
          { type: 'listen-identify', prompt: 'Nuwé', association: '"Noo-WAY" — "new wave" in the water — swim', phonetic: 'noo-WAY', meaning: 'Swim', options: ['Fish', 'Float', 'Swim', 'Dive'], correct: 2 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Tȟáŋka', association: '"TAHN-kah" — like a "tank" — big and powerful', phonetic: 'TAHN-kah', meaning: 'Big / Large', options: ['Small', 'Big', 'Tall', 'Strong'], correct: 1 },
          { type: 'listen-identify', prompt: 'Čísčila', association: '"CHEESH-chee-lah" — a "cheesy" little thing — small', phonetic: 'CHEESH-chee-lah', meaning: 'Small / Little', options: ['Big', 'Small', 'Short', 'Thin'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wašáke', association: '"Wah-SHAH-kay" — "wasabi" strong — powerful!', phonetic: 'wah-SHAH-kay', meaning: 'Strong', options: ['Weak', 'Fast', 'Strong', 'Brave'], correct: 2 },
          { type: 'listen-identify', prompt: 'Kȟatá', association: '"Kah-TAH" — hot like "kata" in hot yoga', phonetic: 'kah-TAH', meaning: 'Hot', options: ['Cold', 'Hot', 'Warm', 'Dry'], correct: 1 },
          { type: 'listen-identify', prompt: 'Sní', association: '"SHNEE" — cold as "snow" — brrr', phonetic: 'SHNEE', meaning: 'Cold', options: ['Hot', 'Wet', 'Cold', 'Dry'], correct: 2 },
          { type: 'listen-identify', prompt: 'Háŋske', association: '"HAHN-skay" — "hands-key" reach up high — tall/long', phonetic: 'HAHN-skay', meaning: 'Tall / Long', options: ['Short', 'Tall / Long', 'Wide', 'Heavy'], correct: 1 },
          { type: 'listen-identify', prompt: 'Ptéčela', association: '"PTAY-chay-lah" — short, a quick little word for a quick little thing', phonetic: 'PTAY-chay-lah', meaning: 'Short', options: ['Tall', 'Wide', 'Short', 'Thin'], correct: 2 },
          { type: 'listen-identify', prompt: 'Šíča', association: '"SHEE-chah" — "she-cha" sounds like trouble — bad', phonetic: 'SHEE-chah', meaning: 'Bad', options: ['Good', 'Bad', 'Ugly', 'Wrong'], correct: 1 },
      ...
      },
      {
        ...
        exercises: [
          ...
          { type: 'listen-identify', prompt: 'Magážu', association: '"Mah-GAH-zhoo" — "my galoshes" — it\'s raining!', phonetic: 'mah-GAH-zhoo', meaning: 'Rain / It\'s raining', options: ['Snow', 'Rain', 'Wind', 'Storm'], correct: 1 },
          { type: 'listen-identify', prompt: 'Wá', association: '"WAH" — "whoa, snow!" — the simplest word for white flakes', phonetic: 'WAH', meaning: 'Snow', options: ['Rain', 'Ice', 'Snow', 'Hail'], correct: 2 },
          { type: 'listen-identify', prompt: 'Čhagá', association: '"Chah-GAH" — ice is "cha-COLD" — frozen', phonetic: 'chah-GAH', meaning: 'Ice', options: ['Snow', 'Water', 'Ice', 'Frost'], correct: 2 },
          { type: 'listen-identify', prompt: 'Wakpá', association: '"Wahk-PAH" — "walk past" the flowing river', phonetic: 'wahk-PAH', meaning: 'River', options: ['Lake', 'River', 'Creek', 'Ocean'], correct: 1 },
          { type: 'listen-identify', prompt: 'Blé', association: '"BLAY" — a lake is a "bay" that\'s "laid" out flat', phonetic: 'BLAY', meaning: 'Lake', options: ['River', 'Pond', 'Lake', 'Sea'], correct: 2 },
          { type: 'listen-identify', prompt: 'Waȟčá', association: '"Wah-HCHAH" — flowers make you go "wahhhh" — beautiful', phonetic: 'wah-HCHAH', meaning: 'Flower', options: ['Tree', 'Grass', 'Flower', 'Berry'], correct: 2 },
          { type: 'listen-identify', prompt: 'Phéži', association: '"PAY-zhee" — grass is the "pays" of the prairie', phonetic: 'PAY-zhee', meaning: 'Grass', options: ['Flower', 'Grass', 'Leaf', 'Weed'], correct: 1 },
          { type: 'listen-identify', prompt: 'Thípi', association: '"TEE-pee" — the classic tipi — a dwelling', phonetic: 'TEE-pee', meaning: 'House / Lodge / Dwelling', options: ['Camp', 'House', 'Door', 'Blanket'], correct: 1 },
